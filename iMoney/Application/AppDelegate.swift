...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setUpInitialController(){
        ...
        let network = Network()
        let wikiService = WikiService(network: network)
        let viewModel = SearchViewModel(network: network, wikiService: wikiService)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "iMoney")
